...
import { Image, Switch, Platform, Pressable, ScrollView, StyleSheet, View } from 'react-native'
...
export default function CreateRestaurantScreen ({ navigation }) {
  ...
  const validationSchema = yup.object().shape({
    ...
    promoted: yup
      .boolean() // Solo esto tenemos que poner cuando la propiedad la trata un switch
  })
            ...
            <View style={{ width: '60%' }}>
              ...
              <TextRegular>Is it promoted?</TextRegular>
                <Switch
                  ...
                  value={values.promoted} // Esto también representa el estado inicial del switch según los valores iniciales que le hemos dado, aparecerá primeramente en falso
                  style={styles.switch}
                  onValueChange={value =>
